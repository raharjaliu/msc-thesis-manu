...
This chapter will consider two aspects of the project: the experiment setting and the data analyis pipeline. In the first half of the chapter, the cell environment is brouht forth. After that, the cell lines used in this experiment are explained with context of the aim of the experiment. Later on, the experiment treatment and the hypothesis is presented.

The second part deals mostly with the quantitative methods used to process data into meaninful observations. Here, the theoretical aspect of each part is brought forward with several rationale explaining the reasons of using the method.
