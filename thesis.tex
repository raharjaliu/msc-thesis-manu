...
CCD & Cell cycle duration & See Subsection \ref{section:cycle_duration}\\
SDT &  Sisters death time & See Section \ref{section:sisters_death_time}
\end{tabular}
\endgroup
...
\section{Correlation of time-to-death to time-in-cycle}
\label{section:time_to_death_time_in_cycle}
