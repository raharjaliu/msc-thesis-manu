...
The smallest structure of the setting
...
\begin{figure}[h]
\centering
\includegraphics[width=1\textwidth]{images/sticky-slide-8-well}
\caption{ibidi\textsuperscript{\textregistered} sticky-Slide 8 Well. The base SU-8 wafer is located in each of the containment box. The wafer in turn holds the manufactured microstructure. Note that each containment box is upside-open. Petri dish-combined installation is done to prevent the ingress of foreign materials into the medium. Picture taken from ibidi website.}
\label{fig:ibidi}
\end{figure}
