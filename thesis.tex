...
An interesting improvement possibility for the microfluidics would be designing cell placement process that is not bound by the Poisson distribution. There are some progresses in the fields of microrobotics for example.
