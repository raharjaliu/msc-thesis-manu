...
\caption{(a) The highlighted area around the 500-th column of the first slice of position 41. The range starts from the 450-th until the 550-th column. (b) The intensity of the marked area in (a)}
\end{figure}

 (TODO citation, citation, citation). One  of such methods is detection using brightness composition \cite{cheng2015global}.
